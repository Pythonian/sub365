...
urlpatterns = [
    ...
    path("serverowner/", include([
        ...
        path("affiliates/payments/pending/", views.pending_affiliate_payment,
            name="pending_affiliate_payment",
        ),
        path("affiliates/payments/confirmed/", views.confirmed_affiliate_payment,
