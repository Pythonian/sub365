# Generated by Django 4.2.6 on 2023-10-11 02:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission_description', models.CharField(blank=True, help_text='Description of permissions to be given to subscribers.', max_length=255, null=True, verbose_name='permission description')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(blank=True, help_text="The ID of the Serverowner's avatar from Discord.", max_length=255, null=True, verbose_name='avatar')),
                ...
                ('stripe_account_id', models.CharField(blank=True, help_text='The stripe account ID of the Serverowner.', max_length=100, null=True, verbose_name='stripe account id')),
                ...
                ('coinpayment_api_secret_key', models.CharField(blank=True, help_text='Coinpayment API secret key of the serverowner.', max_length=255, null=True, verbose_name='coinpayment api secret key')),
                ('coinpayment_api_public_key', models.CharField(blank=True, help_text='Coinpayment API public key of the serverowner.', max_length=255, null=True, verbose_name='coinpayment api public key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(blank=True, help_text='Avatar URL of the subscriber.', max_length=255, null=True, verbose_name='avatar')),
                ('email', models.EmailField(help_text='Email address of the subscriber.', max_length=254, verbose_name='email')),
                ('stripe_customer_id', models.CharField(blank=True, help_text='Stripe customer ID of the subscriber.', max_length=255, null=True, verbose_name='stripe customer id')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subscription_id', models.CharField(blank=True, help_text='The subscription ID associated with this subscription.', max_length=225, verbose_name='subscription id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(blank=True, help_text='Icon of the server on Discord.', max_length=255, null=True, verbose_name='icon')),
