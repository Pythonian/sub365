    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('serverowner', models.ForeignKey(help_text='The serverowner who created the plan.', on_delete=django.db.models.deletion.CASCADE, related_name='plans', to='accounts.serverowner', verbose_name='serverowner')),
            ],
            options={
