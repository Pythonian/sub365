# Generated by Django 5.0.7 on 2024-07-14 18:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("litecoin_address", models.CharField(blank=True, default="", help_text="The Litecoin address of the affiliate, used when registered via CoinPayments.", max_length=255, verbose_name="litecoin address")),
                ("body", models.TextField(blank=True, default="", help_text="Payment details of the affiliate when registered via Stripe.", max_length=300, verbose_name="payment information")),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("updated", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("avatar", models.CharField(blank=True, default="", help_text="The ID of the Serverowner's avatar from Discord.", max_length=255, verbose_name="avatar")),
                ...
                ("stripe_account_id", models.CharField(blank=True, default="", help_text="The stripe account ID of the Serverowner.", max_length=100, verbose_name="stripe account id")),
                ...
                ("total_earnings", models.DecimalField(decimal_places=2, default=0, help_text="Total subscription earnings of the Serverowner.", max_digits=9, validators=[django.core.validators.MinValueValidator(0)], verbose_name="total earnings")),
                ...
                ("coinpayment_api_secret_key", models.CharField(blank=True, default="", help_text="Coinpayment API secret key of the serverowner.", max_length=255, verbose_name="coinpayment api secret key")),
                ("coinpayment_api_public_key", models.CharField(blank=True, default="", help_text="Coinpayment API public key of the serverowner.", max_length=255, verbose_name="coinpayment api public key")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("icon", models.CharField(default="", help_text="Icon of the server on Discord.", max_length=255, verbose_name="icon")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ("name", models.CharField(help_text="The name of the plan.", max_length=100, verbose_name="name")),
                ("amount", models.DecimalField(decimal_places=2, help_text="The amount in dollars for the plan.", max_digits=9, validators=[django.core.validators.MinValueValidator(0)], verbose_name="amount")),
                ("subscription_earnings", models.DecimalField(decimal_places=2, default=0, help_text="The total subscription earnings for this plan.", max_digits=9, validators=[django.core.validators.MinValueValidator(0)], verbose_name="subscription earnings")),
                ...
                ("permission_description", models.CharField(blank=True, default="", help_text="Description of permissions to be given to subscribers.", max_length=255, verbose_name="permission description")),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("updated", models.DateTimeField(auto_now=True)),
                ("serverowner", models.ForeignKey(help_text="The serverowner who created the plan.", on_delete=django.db.models.deletion.CASCADE, related_name="%(class)s_plans", to="accounts.serverowner", verbose_name="serverowner")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("avatar", models.CharField(blank=True, default="", help_text="Avatar URL of the subscriber.", max_length=255, verbose_name="avatar")),
                ("email", models.EmailField(help_text="Email address of the subscriber.", max_length=254, verbose_name="email")),
                ("stripe_customer_id", models.CharField(blank=True, default="", help_text="Stripe customer ID of the subscriber.", max_length=255, verbose_name="stripe customer id")),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("updated", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("subscription_id", models.CharField(blank=True, default="", help_text="The subscription ID associated with this subscription.", max_length=225, verbose_name="subscription id")),
                ...
                ("created", models.DateTimeField(auto_now_add=True)),
                ("updated", models.DateTimeField(auto_now=True)),
                ("session_id", models.CharField(blank=True, default="", help_text="The Stripe checkout session ID associated with this subscription.", max_length=200, verbose_name="session id")),
                ...
                ("subscriber", models.ForeignKey(help_text="The user subscribing to the plan.", on_delete=django.db.models.deletion.CASCADE, related_name="%(class)s_subscriptions", to="accounts.subscriber", verbose_name="subscriber")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("address", models.CharField(blank=True, default="", help_text="The Litecoin address associated with the subscription.", max_length=225, verbose_name="address")),
                ("checkout_url", models.CharField(blank=True, default="", help_text="The CoinPayment URL for subscriber redirection.", max_length=225, verbose_name="checkout url")),
                ("status_url", models.CharField(blank=True, default="", help_text="The URL for accessing transaction status information.", max_length=225, verbose_name="status url")),
